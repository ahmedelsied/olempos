<div class="container">
    <form class="add-article" method="post" action="../../admin_hash_blogs/add" enctype="multipart/form-data">
        ...
        <div class="title-parent">
            <input name="tags" class="form-control text-left" type="text" placeholder="Write Tag Then [ , ]" required="required"/>
        </div>
