                        ...
                        <div class="blog-banner">
                            ...
                            <div class="blog-content">
                                <div class="blog-meta">
                                    ...
                                    <?php
                                    $date = $this->setDateGer($this->blogsDetails[0]['date']);
                                    $dateDetails = $date[0];
                                    $year = $dateDetails[0];
                                    $month = $dateDetails[1];
                                    $day = $dateDetails[2];
                                ...
                                <h4><?=$this->blogsDetails[0]['titleGer']?></h4>
                                <?php $cntnt = str_replace('#123','<blockquote>',$this->blogsDetails[0]['contentGer']) ?>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="left-head-blog">
                        <div class="left-blog-page">
                            <!-- search option start -->
                            <form action="../../blogs/search?lang=ger" method="POST">
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="recent-single-post">
                                        ...
                                        <div class="pst-content">
                                            <p><a href="../../blogs/details/<?=$recentBlog['id']?>"><?=$recentBlog['titleGer']?></a></p>
                                            <span class="date-type">
                                            <?php
                                                $date = $this->setDateGer($recentBlog['date']);
                                                $dateDetails = $date[0];
                                                $year = $dateDetails[0];
                                                $month = $dateDetails[1];
                                                $day = $dateDetails[2];
                            ...
                            <div class="left-tags blog-tags">
                                <div class="popular-tag left-side-tags left-blog">
                                    ...
                                    <?php foreach($tagsArr as $tag): ?>
                                        ...
                                        <li><a href="../../blogs/tags?lang=ger&tag=<?=$tag?>"><?=$tag?></a></li>
                                    <?php endforeach; ?>
                                    </ul>
                                </div>
                            </div>
